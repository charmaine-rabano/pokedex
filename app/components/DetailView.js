...
export default function DetailView({ pokemon, setSelected, max }) {
  ...
  return (
    <>
      ...
      <div className="bg-off-white w-[98vw] md:w-[80vw] h-[85vh] rounded-[85px] fixed overflow-y-auto scrollbar-hide">
        <div className="w-full h-full p-14">
          <button className="absolute top-12 right-12" onClick={() => setSelected(null)}>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-32">
            <Image
              ...
              height={300}
            />
            <div className="flex flex-col text-navy-blue text-xl font-medium gap-2 w-1/2">
              <p className="text-3xl">{pokemon.id}</p>
              <p className="text-denim-blue font-black text-6xl mb-5">
          ...
          <div className="m-14 flex flex-row gap-2 justify-center">
            {pokemon.id != 1 && (
              <Button
                yellow
                text="Previous"
